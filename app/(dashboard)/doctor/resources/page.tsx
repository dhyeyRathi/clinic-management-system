...
export const metadata: Metadata = {
  title: "Resource Requests | Doctor Dashboard",
};
...
export default async function DoctorResourcesPage() {
  ...
  // Fetch all resources (read only access for doctor)
    ...
    <div className="p-6 md:p-8 space-y-6 max-w-7xl">
      <div>
        ...
        <p className="text-muted text-sm mt-1">
          Browse clinical rooms, check-up equipment, and request assets allocation.
        </p>
      </div>
