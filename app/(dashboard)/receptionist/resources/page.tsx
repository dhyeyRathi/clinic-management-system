...
export const metadata: Metadata = {
  title: "Resource Requests | Receptionist Dashboard",
};
...
export default async function ReceptionistResourcesPage() {
  ...
  // Fetch all resources (read only access for receptionist)
  ...
  // Fetch requests made by this receptionist
    ...
    <div className="p-6 md:p-8 space-y-6 max-w-7xl">
      <div>
        ...
        <p className="text-muted text-sm mt-1">
          Browse rooms, check-up equipment, and request assets allocation.
        </p>
      </div>
